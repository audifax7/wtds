...
const HomePage = () => {
  return (
    <>
      <section className="mx-auto grid min-h-[calc(80vh-300px)] max-w-5xl flex-col  items-center justify-center gap-1 py-2 text-center  md:py-2"        style={{ backgroundImage: "url('/images/wasac.jpg')" }}
      >

      </section>
      <section className="mx-auto grid min-h-[calc(100vh-300px)] max-w-5xl flex-col  items-center justify-center gap-1 py-2 text-center  md:py-2" >
        <div className="p-2">
